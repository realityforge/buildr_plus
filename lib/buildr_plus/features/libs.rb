...
BuildrPlus::FeatureManager.feature(:libs) do |f|
  f.enhance(:Config) do
    ...
    def arez_spytools
      %w(org.realityforge.arez.spytools:arez-spytools:jar:0.83)
    end
    ...
    def replicant5_client_qa_support
      %W(org.realityforge.replicant:replicant-client-qa-support:jar:#{replicant5_version}) + self.guiceyloops_gwt
    end
