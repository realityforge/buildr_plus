...
BuildrPlus::FeatureManager.feature(:libs) do |f|
  f.enhance(:Config) do
    ...
    def jetbrains_annotations
      %w(org.realityforge.org.jetbrains.annotations:org.jetbrains.annotations:jar:1.2.0)
    end
    ...
    def braincheck
      %w(org.realityforge.braincheck:braincheck:jar:1.25.0)
    end
    ...
    def keycloak_gwt
      %w(org.realityforge.gwt.keycloak:gwt-keycloak:jar:0.5) + self.elemental2_webstorage
    end
    ...
    def arez_spytools
      %w(org.realityforge.arez.spytools:arez-spytools:jar:0.95)
    end

    def arez_dom
      %w(org.realityforge.arez.dom:arez-dom:jar:0.54)
    end
    ...
    def guiceyloops_lib
      'org.realityforge.guiceyloops:guiceyloops:jar:0.106'
    end
