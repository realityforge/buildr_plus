...
BuildrPlus::FeatureManager.feature(:libs) do |f|
  f.enhance(:Config) do
    ...
    def akasha
      %w(org.realityforge.akasha:akasha-gwt:jar:0.21)
    end
    ...
    def guiceyloops
      self.mockito + self.testng + %w(org.realityforge.guiceyloops:guiceyloops:jar:0.109) + self.guice + self.glassfish_embedded
    end
