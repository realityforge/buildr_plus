...
BuildrPlus::FeatureManager.feature(:libs) do |f|
  f.enhance(:Config) do
    ...
    def arez_spytools
      %w(org.realityforge.arez.spytools:arez-spytools:jar:0.100)
    end

    def arez_testng
      %w(org.realityforge.arez.testng:arez-testng:jar:0.05)
    end

    def arez_dom
      %w(org.realityforge.arez.dom:arez-dom:jar:0.60)
    end
