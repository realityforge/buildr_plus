...
BuildrPlus::FeatureManager.feature(:libs) do |f|
  f.enhance(:Config) do
    ...
    def giggle
      'org.realityforge.giggle:giggle-compiler:jar:all:0.12'
    end
    ...
    def arez_spytools
      %w(org.realityforge.arez.spytools:arez-spytools:jar:0.119)
    end
    ...
    def guiceyloops
      self.mockito + self.testng + %w(org.realityforge.guiceyloops:guiceyloops:jar:0.107) + self.guice + self.glassfish_embedded
    end
