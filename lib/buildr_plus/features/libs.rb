...
BuildrPlus::FeatureManager.feature(:libs) do |f|
  f.enhance(:Config) do
    ...
    def giggle
      'org.realityforge.giggle:giggle-compiler:jar:all:0.05'
    end
    ...
    def glassfish_embedded
      %w(fish.payara.extras:payara-embedded-all:jar:5.192)
    end
    ...
    def braincheck
      %w(org.realityforge.braincheck:braincheck:jar:1.20.0)
    end
    ...
    def graphql_domgen_support
      %w(org.realityforge.keycloak.domgen:graphql-domgen-support:jar:1.5.0)
    end
    ...
    def guiceyloops_lib
      'org.realityforge.guiceyloops:guiceyloops:jar:0.102'
    end
