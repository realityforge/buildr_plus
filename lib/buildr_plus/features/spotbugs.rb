...
module BuildrPlus::Spotbugs
  ...
  def self.setup_filter_config
    ...
    if BuildrPlus::FeatureManager.activated?(:arez)
      config.rule('CLI_CONSTANT_LIST_INDEX,IICU_INCORRECT_INTERNAL_CLASS_USE,CC_CYCLOMATIC_COMPLEXITY,EXS_EXCEPTION_SOFTENING_NO_CHECKED,PME_POOR_MANS_ENUM,PRMC_POSSIBLY_REDUNDANT_METHOD_CALLS,EI_EXPOSE_REP,RCN_REDUNDANT_NULLCHECK_WOULD_HAVE_BEEN_A_NPE',
