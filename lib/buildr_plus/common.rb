...
BuildrPlus::FeatureManager.activate_features([:repositories, :idea, :idea_codestyle, :roles, :product_version, :dialect_mapping, :libs, :publish, :whitespace, :gitignore, :artifact_assets, :ci])
