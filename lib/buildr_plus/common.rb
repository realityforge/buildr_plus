...
BuildrPlus::FeatureManager.activate_features([:repositories, :artifacts, :idea, :idea_codestyle, :roles, :product_version, :dialect_mapping, :libs, :publish, :whitespace, :gitignore, :artifact_assets, :ci])
