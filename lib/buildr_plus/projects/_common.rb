...
BuildrPlus::FeatureManager.activate_features([:checks, :repositories, :artifacts, :idea, :idea_codestyle, :roles, :product_version, :libs, :deps, :publish, :whitespace, :gitignore, :gitattributes, :artifact_assets, :ci, :config])
