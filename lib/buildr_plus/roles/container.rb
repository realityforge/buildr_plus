    ...
    BuildrPlus::Roles.buildr_projects_with_role(:user_experience).each do |p|
      ...
      gwt_modules.each do |gwt_module|
        ...
        ipr.add_gwt_configuration(p,
                                  ...
                                  :shell_parameters => "#{BuildrPlus::Gwt.enable_gwt_js_exports? ? '-generateJsInteropExports ' : ''}-port 8888 -codeServerPort 8889 -bindAddress 0.0.0.0 -war #{_(:generated, 'gwt-export')}/ -style PRETTY -XmethodNameDisplayMode FULL -noincremental -logLevel INFO",
